                    ...
                    allBatches?.map(item => {
                        return <div key={item.id} className='w-full px-4 py-2 bg-white rounded h-24'>
                            ...
                            <div className='flex justify-center items-center'>
                                ...
                                <button className='bg-[#2091F9] rounded-lg hover: py-[2px] tracking-wider font-medium capitalize text-white text-[14px] px-2 text-clrprimary10 transition-all ease-linear duration-300 w-[70px] disabled:cursor-not-allowed block mx-auto'>
                                    Edit
                                </button>
