...
export default function DeleteDepartmentModal({ showModal, setShowModal, cookie, id }) {
    ...
    const handleDelete = async () => {
        try {
            setprocess("Deleting ...")
            const { data } = await axios.delete(`http://localhost:8000/api/admin/department/${id}/delete/`, {
