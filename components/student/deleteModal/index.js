...
export default function DeleteApplicationModal({ showModal, setShowModal, cookie, id }) {
    ...
    const handleDelete = async () => {
        try {
            setprocess("Deleting ...")
            const { data } = await axios.delete(`http://localhost:8000/api/leave-request/delete/${id}`, {
            ...
            if (data) {
                ...
                setprocess("Yes")
                setShowModal(false)
                router.push("/student/leaveapplication")
            }
